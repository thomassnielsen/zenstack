...
## [2.0.0-alpha.2](https://github.com/thomassnielsen/zenstack/compare/v2.0.0-alpha.1...v2.0.0-alpha.2) (2024-11-26)
...
* allow using a type as auth model ([#1841](https://github.com/thomassnielsen/zenstack/issues/1841)) ([e59d940](https://github.com/thomassnielsen/zenstack/commit/e59d940db3b86fceb5dcec5e752f7a982e934307))
...
* **hooks:** add "portable" generation mode ([#1850](https://github.com/thomassnielsen/zenstack/issues/1850)) ([04184b9](https://github.com/thomassnielsen/zenstack/commit/04184b95cfb9ac1eb01e529731e93cf44ffb74a7))
* **hooks:** optimistic update for nested relations ([#1842](https://github.com/thomassnielsen/zenstack/issues/1842)) ([a003be9](https://github.com/thomassnielsen/zenstack/commit/a003be9ee46daf791550993cf2b595f4ed9f9214))
...
* **openapi:** add plugin option to omit generating input object details for RPC flavor ([#1852](https://github.com/thomassnielsen/zenstack/issues/1852)) ([3134f0d](https://github.com/thomassnielsen/zenstack/commit/3134f0df1eff9cfb916926bd05e29a79901dae7e))
...
* **repl:** add CLI option to specify custom zenstack load path ([#1823](https://github.com/thomassnielsen/zenstack/issues/1823)) ([d985a73](https://github.com/thomassnielsen/zenstack/commit/d985a733f3ac8dea755c139c4f404f9be98f407a))
...
* **zmodel:** "type" construct and strongly-typed Json fields ([#1813](https://github.com/thomassnielsen/zenstack/issues/1813)) ([00ccb73](https://github.com/thomassnielsen/zenstack/commit/00ccb7395a0c27b5fef28157b48c56351eaa9a66))
...
* avoid reference unused enums in generated policy code ([#1851](https://github.com/thomassnielsen/zenstack/issues/1851)) ([e41a927](https://github.com/thomassnielsen/zenstack/commit/e41a927dfe387074a3853c975c50c8a0974ae9ba))
...
* **cli:** bogus validation error when merging imported enums ([#1861](https://github.com/thomassnielsen/zenstack/issues/1861)) ([ad07053](https://github.com/thomassnielsen/zenstack/commit/ad070538f37480b8e4cc90f13f1005489d27afeb))
...
* **delegate:** delegate model shouldn't inherit `@[@index](https://github.com/index)` from an indirect abstract base ([#1818](https://github.com/thomassnielsen/zenstack/issues/1818)) ([daa3839](https://github.com/thomassnielsen/zenstack/commit/daa38398d73d2dccd965a25eb29424276cada03f))
...
* **delegate:** orderBy with base field doesn't work when the clause is an array ([#1824](https://github.com/thomassnielsen/zenstack/issues/1824)) ([f16225c](https://github.com/thomassnielsen/zenstack/commit/f16225cf1dc0cf4c78665575788ddb485a4e01bf))
...
* **delegate:** self relation support ([#1821](https://github.com/thomassnielsen/zenstack/issues/1821)) ([2bb8970](https://github.com/thomassnielsen/zenstack/commit/2bb897043400cd653fffcac0eb2e41b412e43da3))
...
* don't use package name starting with dot ([#1854](https://github.com/thomassnielsen/zenstack/issues/1854)) ([85a8d5d](https://github.com/thomassnielsen/zenstack/commit/85a8d5d7f5baf5765a300530f8a7b19b1d8ad5a3))
...
* **hooks:** add null check to data before further deserialization ([#1822](https://github.com/thomassnielsen/zenstack/issues/1822)) ([00ecb2a](https://github.com/thomassnielsen/zenstack/commit/00ecb2a7486b7191261b8f7a0b497afef5aa25a1))
* **hooks:** prefer to use global fetch when available ([3ed1614](https://github.com/thomassnielsen/zenstack/commit/3ed1614939dd6a9359edd4fbece5a85cbfc61fd7))
* **hooks:** prefer to use global fetch when available ([#1826](https://github.com/thomassnielsen/zenstack/issues/1826)) ([9eb241f](https://github.com/thomassnielsen/zenstack/commit/9eb241fc9cb700a798682f6e0a47e2a03aa0299a))
...
* ignore file from typechecking ([#1846](https://github.com/thomassnielsen/zenstack/issues/1846)) ([716091e](https://github.com/thomassnielsen/zenstack/commit/716091e5dfc6e84a0d29634ab16665431c001202))
...
* **json:** false error when using typed json in multi-file schemas ([#1836](https://github.com/thomassnielsen/zenstack/issues/1836)) ([1d1fec0](https://github.com/thomassnielsen/zenstack/commit/1d1fec0019fdc14faf7704c671bbfdc919ab797b))
* **json:** support enums in type declarations ([#1837](https://github.com/thomassnielsen/zenstack/issues/1837)) ([1bd1b8f](https://github.com/thomassnielsen/zenstack/commit/1bd1b8f8b7de13042a69aff4742519c6b7c1e5b6))
...
* missing arg passing to recursion ([#1832](https://github.com/thomassnielsen/zenstack/issues/1832)) ([13f95d2](https://github.com/thomassnielsen/zenstack/commit/13f95d270adc92fd6a5658d7e4abc05edce8d1e6))
...
* **server:** change nextjs adapter's context params to be Promise to satisfy Next15's linter ([#1809](https://github.com/thomassnielsen/zenstack/issues/1809)) ([28b130f](https://github.com/thomassnielsen/zenstack/commit/28b130ffa31a070e52a33eba413b78518a21d237))
...
* support `check()` policy function call in permission checkers ([#1820](https://github.com/thomassnielsen/zenstack/issues/1820)) ([be28f2e](https://github.com/thomassnielsen/zenstack/commit/be28f2e731b4edf2409d17318c809978a474b0ad))
...
* **zmodel:** prefer to use triple-slash comments as ZModel documentation ([#1817](https://github.com/thomassnielsen/zenstack/issues/1817)) ([d223819](https://github.com/thomassnielsen/zenstack/commit/d223819d29be241e37e26deafdf857753eb6f109))
